...
$hero = array(
    'eyebrow'     => kapunka_get_meta( 'profesionales_hero_eyebrow', __( 'DIVISIÓN PROFESIONAL', 'understrap' ) ),
    'title'       => kapunka_get_meta( 'profesionales_hero_title', __( 'Eleve sus protocolos estéticos.', 'understrap' ) ),
    'description' => kapunka_get_meta( 'profesionales_hero_description', __( 'Línea exclusiva de alto rendimiento para clínicas, spas de lujo y hoteles. Incluye formación técnica de nuestro método.', 'understrap' ) ),
    'primary'     => array(
        'label' => kapunka_get_meta( 'profesionales_hero_primary_label', __( 'Solicitar Partnership', 'understrap' ) ),
        'url'   => kapunka_get_meta( 'profesionales_hero_primary_url', home_url( '/contacto#profesionales' ) ),
    ),
    'secondary'   => array(
        'label' => kapunka_get_meta( 'profesionales_hero_secondary_label', __( 'Ver kit profesional', 'understrap' ) ),
        'url'   => kapunka_get_meta( 'profesionales_hero_secondary_url', home_url( '/profesionales#kit' ) ),
    ),
    'image_id'    => (int) kapunka_get_meta( 'profesionales_hero_image', 0 ),
);
